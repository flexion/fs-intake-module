...
module.exports = {
  up: function(queryInterface, Sequelize) {
    return queryInterface.createTable('tempOutfitterApplications', {
      ...
      applicantInfoPrimaryFirstName: { type: Sequelize.STRING, field: 'applicant_info_primary_first_nm', allowNull: false },
      applicantInfoPrimaryLastName: { type: Sequelize.STRING, field: 'applicant_info_primary_last_nm', allowNull: false },
      applicantInfoDayPhoneAreaCode: { type: Sequelize.STRING(3), field: 'applicant_info_day_phone_areacd', allowNull: false },
      applicantInfoDayPhonePrefix: { type: Sequelize.STRING(3), field: 'applicant_info_day_phone_prefix', allowNull: false },
      applicantInfoDayPhoneNumber: { type: Sequelize.STRING(4), field: 'applicant_info_day_phone_number', allowNull: false },
      ...
      applicantInfoPrimaryMailingAddress: { type: Sequelize.STRING, field: 'appl_info_pri_mailing_address', allowNull: false },
      applicantInfoPrimaryMailingAddress2: { type: Sequelize.STRING, field: 'appl_info_pri_mailing_address2' },
      applicantInfoPrimaryMailingCity: { type: Sequelize.STRING, field: 'appl_info_pri_mailing_city', allowNull: false },
      applicantInfoPrimaryMailingState: { type: Sequelize.STRING(2), field: 'appl_info_pri_mailing_state', allowNull: false },
      applicantInfoPrimaryMailingZIP: { type: Sequelize.STRING(5), field: 'appl_info_pri_mailing_zip', allowNull: false },
  ...
  down: function(queryInterface, Sequelize) {
    return queryInterface.dropTable('tempOutfitterApplications');
  }
};
